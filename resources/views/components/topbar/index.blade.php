...
<div class="mt-8">
    <nav class="flex items-center gap-x-2 bg-white px-4 py-2 rounded-md ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 md:px-4 lg:px-4 overflow-x-scroll">
